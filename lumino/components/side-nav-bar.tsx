  ...
  return (
    <aside className="hidden lg:flex flex-col h-[calc(100vh-64px)] w-64 fixed left-0 top-16 bg-slate-50/50 backdrop-blur-xl p-4 space-y-2 font-medium z-40 border-r border-slate-100">
      ...
      <div className="mt-auto pt-4 space-y-1">
        ...
        <Link href="/settings" className="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-indigo-950 transition-colors">
          <Settings size={18} />
          <span className="text-sm">Settings</span>
        </Link>
        <Link href="/support" className="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-indigo-950 transition-colors">
          <HelpCircle size={18} />
